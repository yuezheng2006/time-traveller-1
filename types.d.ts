...
declare module 'motia' {
  ...
  interface Handlers {
    ...
    'ParseTravelCommand': ApiRouteHandler<{ message: string; history: Array<string>; language: string }, ApiResponse<200, { isJump: boolean; reply: string; params?: { destination: string; era: string; style: string } }> | ApiResponse<400, { error: string }>, never>
