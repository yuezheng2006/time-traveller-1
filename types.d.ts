...
declare module 'motia' {
  ...
  interface Handlers {
    ...
    'GenerateImage': EventHandler<{ teleportId: string; destination: string; era: string; style: string; coordinates?: { lat: number; lng: number }; imageConfig?: { aspectRatio: '1:1' | '2:3' | '3:2' | '3:4' | '4:3' | '4:5' | '5:4' | '9:16' | '16:9' | '21:9'; imageSize: '1K' | '2K' | '4K' } }, { topic: 'image-generated'; data: { teleportId: string } }>
    ...
    'InitiateTeleport': ApiRouteHandler<{ destination: string; era: string; style: string; referenceImage?: string; coordinates?: { lat: number; lng: number }; imageConfig?: { aspectRatio: '1:1' | '2:3' | '3:2' | '3:4' | '4:3' | '4:5' | '5:4' | '9:16' | '16:9' | '21:9'; imageSize: '1K' | '2K' | '4K' } }, ApiResponse<201, { teleportId: string; status: string; message: string }> | ApiResponse<400, { error: string }> | ApiResponse<401, { error: string }>, { topic: 'generate-image'; data: { teleportId: string; destination: string; era: string; style: string; coordinates?: { lat: number; lng: number }; imageConfig?: { aspectRatio: '1:1' | '2:3' | '3:2' | '3:4' | '4:3' | '4:5' | '5:4' | '9:16' | '16:9' | '21:9'; imageSize: '1K' | '2K' | '4K' } } } | { topic: 'generate-location-details'; data: { teleportId: string; destination: string; era: string } }>
