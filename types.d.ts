...
declare module 'motia' {
  ...
  interface Handlers {
    'SynthesizeSpeech': EventHandler<{ teleportId: string; text: string; language: string }, { topic: 'audio-synthesized'; data: { teleportId: string } }>
    'GenerateLocationDetails': EventHandler<{ teleportId: string; destination: string; era: string; language: string }, { topic: 'location-details-generated'; data: { teleportId: string } } | { topic: 'synthesize-speech'; data: { teleportId: string; text: string; language: string } }>
